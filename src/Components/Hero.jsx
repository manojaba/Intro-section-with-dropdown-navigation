    ...
    return (
        <div>
            ...
            <div className='mt-[24px] md:flex flex-row-reverse md:mr-[80px] md:mt-[67px] xl:mr-[130px] md:ml-[100px] xl:ml-[165px] md:mb-[130px] md:gap-x-[80px] xl:gap-x-[125px] items-center'>
                <picture >
                    <source srcSet='src\images\image-hero-desktop.png' media='(min-width:768px)'></source>
                    <img src='src\images\image-hero-mobile.png'
                        alt='hero image'
                    >
                    </img>
                </picture>
                <div className='mx-[6px] md:mx-0   '>
                    ...
                    <div className='flex flex-wrap items-center justify-between  mt-[48px]  md:mt-[108px] mx-[10px] md:mx-0 '>
                        <img className='max-w-[80px] md:max-w-[113px] h-auto ' src='src\images\client-databiz.svg' alt='databiz icon'></img>
                        <img className='max-w-[53px] md:max-w-[73px] h-auto ' src='src\images\client-audiophile.svg' alt='audiophile icon'></img>
                        <img className='max-w-[64px] md:max-w-[90px] h-auto ' src='src\images\client-meet.svg' alt='meet icon'></img>
                        <img className='max-w-[60px] md:max-w-[82px] h-auto ' src='src\images\client-maker.svg' alt='maker icon'></img>
                    </div>
